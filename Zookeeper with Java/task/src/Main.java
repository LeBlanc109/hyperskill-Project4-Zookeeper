...
public class Main {
    public static void main(String[] args) {
        ...
        while(keepGoing){
            ...
            String desiredHabitatString = scanner.next();


            if(desiredHabitatString.equals("exit")){
                System.out.println("See you later!");
                break;
            }

            int desiredHabitat = Integer.parseInt(desiredHabitatString);

            switch(desiredHabitat){
                case 0:
